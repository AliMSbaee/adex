(function () {
    ...
    $("#category").select2({
        ...
        language: {
            noResults: function() {
                return '<a href="#createCategoryModal" class="ws-normal btn btn-success btn-block btn-sm" onclick="addNewCategory(this)">Create New Category</a>';
            }
        },
        theme: "bootstrap"
    });
...
function addNewCategory(anchor) {
